...
var resend = new resend_1.Resend("re_c2LD2CH5_6UTNZw9C3XtU78D9KumFFUy8");
        ...
        switch (_c.label) {
            ...
            case 5:
                ...
                return [4 /*yield*/, resend.emails.send({
                        from: 'Art Street <onboarding@resend.dev>',
                        to: [user.email],
                        subject: '¡Gracias por su compra! Está en recepción',
            ...
            case 6:
                data = _c.sent();
                console.log("Ha enviado el correo al:", user.email);
