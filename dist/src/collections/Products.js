...
var optionsList_1 = require("../utilities/optionsList");
...
exports.Products = {
    ...
    access: {
        create: function (_a) {
            var req = _a.req;
            return req.user.role === "admin" || req.user.role === "sell";
        },
        update: function (_a) {
            var req = _a.req;
            return req.user.role === "admin" || req.user.role === "sell";
    ...
    fields: [
        ...
        },
        {
            ...
            label: "Categoría",
            type: "select",
            options: optionsList_1.filterTypes.map(function (category) { return ({
                label: category,
                value: category,
            }); }),
            required: true,
