...
var ReceiptEmail = function (_a) {
    ...
    return (React.createElement(components_1.Html, null,
        ...
        React.createElement(components_1.Preview, null, "Tu Pedido Art Street"),
        React.createElement(components_1.Body, { style: main },
            React.createElement(components_1.Container, { style: container },
                React.createElement(components_1.Section, null,
                    React.createElement(components_1.Column, null,
                        React.createElement(components_1.Img, { src: "".concat(process.env.NEXT_PUBLIC_SERVER_URL, "/assets/images/LogoArtStreetTransparente.png"), width: '100', height: '100', alt: 'Art Street Logo' })),
                    React.createElement(components_1.Column, { align: 'right', style: tableCell },
                        React.createElement(components_1.Text, { style: heading }, "Recibido"))),
                React.createElement(components_1.Section, { style: informationTable },
                    React.createElement(components_1.Row, { style: informationTableRow },
                        ...
                        React.createElement(components_1.Column, { style: informationTableColumn },
                            React.createElement(components_1.Text, { style: informationTableLabel }, "Fecha"),
                            React.createElement(components_1.Text, { style: informationTableValue }, (0, date_fns_1.format)(date, 'dd MMM yyyy'))),
                        React.createElement(components_1.Column, { style: informationTableColumn },
                            React.createElement(components_1.Text, { style: informationTableLabel }, "ID Orden"),
                ...
                React.createElement(components_1.Section, { style: productTitleTable },
                    React.createElement(components_1.Text, { style: productsTitle }, "Resumen de Compra")),
                products.map(function (product) {
                    ...
                    return (React.createElement(components_1.Section, { key: product.id },
                        ...
                        React.createElement(components_1.Column, { style: { paddingLeft: '22px' } },
                            ...
                            React.createElement(components_1.Link, { href: "".concat(process.env.NEXT_PUBLIC_SERVER_URL, "/thank-you?orderId=").concat(orderId), style: productLink }, "Descargar Archivo")),
                ...
                React.createElement(components_1.Text, { style: footerCopyright },
                    "Copyright \u00A9 2024 Art Street ",
                    React.createElement("br", null),
                    ' ',
                    React.createElement(components_1.Link, { href: '#' }, "Todos los Derechos Reservados"))))));
};
