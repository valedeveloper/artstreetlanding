...
import { EmailCredential, TEmailCredential } from "@/lib/validators/credentialsValidator";
import { zodResolver } from "@hookform/resolvers/zod";
import { toast } from "sonner";
import { ZodError } from "zod";

function WaitScreen(): JSX.Element {
  const { mutate, isLoading, isSuccess } = trpc.auth.createEmailWaitList.useMutation({
    onError: (err) => {
  ...
  return (
    ...
    >
      <div className=" flex flex-col justify-center items-center  gap-y-5   ">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col items-center justify-center gap-8  w-full px-5 lg:flex-row ">
