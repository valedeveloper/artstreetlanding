...
function Intro(): JSX.Element {
  return (
      <div className=" bg-black text-white p-24 text-center flex flex-col gap-5 items-center  " id="intro">
        ...
        <CallToAction  onClick={() => scrollToSection("wait-list")} title="Notifícame cuando estén listos" className=" bg-transparent border-2 border-primaryYelow text-primaryYelow w-full md:w-max hover:bg-primaryYelow hover:text-black p-4   " />
      </div>
  );
}
