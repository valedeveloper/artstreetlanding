...
import { ReceiptEmailProps } from '../../../types/types'
...
export const ReceiptEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>Tu Pedido Art Street</Preview>
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={productTitleTable}>
            <Text style={productsTitle}>Resumen de Compra</Text>
          </Section>
